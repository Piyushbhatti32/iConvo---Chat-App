...
const ChatArea: React.FC<ChatAreaProps> = ({
  ...
  if (!currentRoom) {
    return (
      <div className="h-full flex-1 flex items-center justify-center bg-gray-800">
        <div className="text-center px-4">
          <svg
            className="w-16 h-16 md:w-24 md:h-24 mx-auto mb-4 opacity-50 text-gray-600"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
        ...
        <div className="flex items-end space-x-2 md:space-x-3">
          <div className="flex-1 relative min-w-0">
            ...
            {showEmojiPicker && (
              <div
                ref={emojiPickerRef}
                className="absolute bottom-[calc(100%+8px)] left-0 right-0 md:left-auto md:right-auto z-20"
              >
